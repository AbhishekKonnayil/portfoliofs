...
function Landing() {
    ...
    return (
        <div className='flex flex-col sm:flex-row  relative'>
            {/* <div
                className='hidden sm:block sm:w-[35%] w-full h-[120px] sm:h-auto flex-col justify-end items-center mt-auto'
            ...
            <div
                className='flex flex-col sm:flex-row justify-end p-8 sm:justify-center sm:gap-20 items-center flex-1 sm:w-[65%]'
                style={{ backgroundColor: theme.secondary }}
            >
                <img
                    src={headerData.image}
                    alt='landing'
                    className='rounded-[50%] size-[200px] sm:size-[400px]'
                    style={{
                        opacity: drawerOpen ? '0' : '1',
                        borderColor: theme.secondary,
                    }}
                />
                <div className='' style={{ color: theme.primary80 }}>
                    <div className='font-exo flex flex-col gap-4 items-center justify-end'><h6 className='font-medium text-[1.25rem] mb-[-0.85rem] opacity-[0.8]'>{headerData.title}</h6>
