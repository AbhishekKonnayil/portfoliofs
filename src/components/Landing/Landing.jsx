    ...
    return (
        <div className='flex flex-col sm:flex-row min-h-screen relative'>
            ...
            <img
                ...
                alt='landing'
                className='size-[200px] left-[50%] bottom-[30%] transform translate-x-[-50%] translate-y-[-80%] absolute object-cover rounded-[50%] shadow-[0px_0px_30px_rgba(0,0,0,0.2)] transition-opacity duration-300 lg:size-[400px] sm:size-[250px] sm:left-[28%] sm:translate-y-0 sm:bottom-[25%] sm:translate-x-[-40%] '
                style={{
